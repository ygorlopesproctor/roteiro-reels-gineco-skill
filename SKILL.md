...
| 🆕 `references/funil-e-consciencia.md` | **v2.1** · eixo de FUNIL (topo/meio/fundo) + premissa das 3 CONSCIÊNCIAS (problema/solução/doutora) + playbook do mentor Elias (mecânicas CFM-safe) → modula ângulo/arquétipo/CTA/formato |
